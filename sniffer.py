...
Run as root/admin: sudo python3 sniffer.py -i eth0
"""
...
try:
    from scapy.all import (
        ...
        DNS, DNSQR, Raw, ARP, conf, get_if_list
    )
except ImportError:
...
stats = {
    "total": 0,
    "protocols": Counter(),   # TCP/UDP/ICMP/ARP/other
    "hosts": Counter(),       # (src, dst) flows
    "bytes": 0,
}
...
def analyze_layers(packet):
    ...
    # ---- HTTP (heuristic on port/payload) ----
